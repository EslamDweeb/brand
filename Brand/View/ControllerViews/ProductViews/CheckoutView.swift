...
//    lazy var viewAddress: shadowView = {
//        let view = shadowView()
//
//        return view
//    }()
...
//
       ...
       // viewAddress.anchor(top: navView.bottomAnchor, left: self.leftAnchor, bottom: nil, right: self.rightAnchor, centerX: self.centerXAnchor, centerY: nil, paddingTop: 8, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 220, paddingCenterX: 0, paddingCenterY: 0)
       // viewAddress.setShadow(shadowColor: UIColor(red: 0, green: 0, blue: 0, alpha: 0.24).cgColor , shadowOffset: CGSize(width: 0, height: 2), shadowOpacity: 0.4, shadowRaduis: 1)
        ...
        changeBtn.anchor(top: viewwithAddress.topAnchor, left: nil, bottom: nil, right: viewwithAddress.rightAnchor, centerX: nil, centerY: nil, paddingTop: 6, paddingLeft: 0, paddingBottom: 0, paddingRight: 6, width: 35, height: 35, paddingCenterX: 0, paddingCenterY: 0)
         ...
         viewnoaddress.anchor(top: scrollView.topAnchor, left: self.leftAnchor, bottom: nil, right: self.rightAnchor, centerX: self.centerXAnchor, centerY: nil, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 90, paddingCenterX: 0, paddingCenterY: 0)
  ...
  ///      save.anchor(top:nil, left: scrollView.leftAnchor, bottom: scrollView.bottomAnchor, right: scrollView.rightAnchor, centerX: nil, centerY: nil, paddingTop: 0, paddingLeft:8, paddingBottom: 16, paddingRight: 8, width: 0, height: 45, paddingCenterX: 0, paddingCenterY: 0)
