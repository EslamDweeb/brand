...
class CartView : UIView  {
    ...
    func setupView() {
        ...
        tableView.anchor(top: scrollView.topAnchor, left: leftAnchor, bottom: scrollView.bottomAnchor, right: rightAnchor, centerX: nil, centerY: nil, paddingTop:16, paddingLeft: 8, paddingBottom: 0, paddingRight: 8, width: 0, height: 0, paddingCenterX: 0, paddingCenterY: 0)
        bottomConstrain = tableView.heightAnchor.constraint(equalToConstant: 0)
        bottomConstrain?.isActive = true
        
       Totalsar.anchor(top: nil, left: scrollView.leftAnchor, bottom: save.topAnchor, right: nil, centerX: nil, centerY: nil, paddingTop: 0, paddingLeft: 16, paddingBottom:16, paddingRight: 0, width: 0, height: 0, paddingCenterX: 0, paddingCenterY: 0)
        ...
        save.anchor(top: nil, left: scrollView.leftAnchor, bottom: self.bottomAnchor, right: scrollView.rightAnchor, centerX: scrollView.centerXAnchor, centerY: nil, paddingTop: 0, paddingLeft: 16, paddingBottom: 40, paddingRight: 16, width: 0, height: 45, paddingCenterX: 0, paddingCenterY: 0)
