...
//            }
    ...
    private func setup(){
        ...
        infoBtn.anchor(top: nil, left: nil, bottom: nil, right: containerView.rightAnchor, centerX: nil, centerY: discountPrice.centerYAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 8, width: 20, height: 20, paddingCenterX: 0, paddingCenterY: 0)
            ...
            discountLbl.anchor(top: productName.bottomAnchor, left: nil, bottom: nil, right: priceLbl.leftAnchor, centerX: nil, centerY: priceLbl.centerYAnchor, paddingTop: 8, paddingLeft: 0, paddingBottom: 0, paddingRight: 16, width: 50, height: 0, paddingCenterX: 0, paddingCenterY: 0)
