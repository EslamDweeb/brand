...
class SizeView: UIView {
    ...
    lazy var titleLable:UILabel = {
        let lbl = UILabel()
        lbl.text = NSLocalizedString("size", comment: "")
        lbl.font = UIFont(name: .fontH, size: 16)
        return lbl
    }()
    lazy var sizeCollection:UICollectionView = {
    ...
    private func addConstraintsToViews(){
        ...
        sizeCollection.anchor(top: titleLable.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, centerX: nil, centerY: nil, paddingTop: 8, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 40, paddingCenterX: 0, paddingCenterY: 0)
...
extension SizeView:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
